...
block = do
  ...
  optional (A.word8 0x88 *> A.word8 0x01 *> varint @Int64)  -- granularity
  optional (A.word8 0x90 *> A.word8 0x01 *> varint @Int32)  -- date_granularity
  optional (A.word8 0x98 *> A.word8 0x01 *> varint @Int64)  -- lat_offset
  optional (A.word8 0xa0 *> A.word8 0x01 *> varint @Int64)  -- lon_offset
...
offset :: Int64 -> Double
offset coord = {-# SCC offset #-} 0.000000001 * fromIntegral (100 * coord)
{-# INLINE offset #-}
